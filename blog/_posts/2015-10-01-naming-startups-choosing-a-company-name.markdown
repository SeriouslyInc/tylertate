...
This is an oversimplification. Whether a domain ends in .com is just one of several important characteristics to consider in naming a startup. _When_ (and when not to) splurge on a .com is the more fundamental question. (You can skip to the end for a rule of thumb, or stick around for my story.)
