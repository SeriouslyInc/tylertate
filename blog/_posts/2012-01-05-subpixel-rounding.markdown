...
snippet: "An old, ugly problem still plagues fluid layouts: sub-pixel rounding. You've experienced this nasty issue when elements within your percentage-based layout unexpectedly wrap to the next line in Internet Explorer, or aren't flush with the right-hand edge in Safari and Chrome."
---
...
<img src="http://tylertate.com/resources/images/2012-01-05/browser-subpixel-rounding.png" width="620" style="width: 100%; max-width: 620px;" alt="The sub-pixel rounding problem" />
...
<img src="http://tylertate.com/resources/images/2012-01-05/browser-subpixel-rounding-corrected.png" width="620" style="width: 100%; max-width: 620px;" alt="Sub-pixel rounding with the correction formula applied" />
